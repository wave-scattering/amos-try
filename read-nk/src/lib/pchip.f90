!  PCHIP is a FORTRAN90 library which can construct a piecewise cubic Hermite
! interpolant to data, and carry out various related operations, by Fred Fritsch.
! Licensing:
!
